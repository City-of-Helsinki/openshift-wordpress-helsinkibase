...
RUN dnf update -y  && \
    ...
    dnf -y install gcc make autoconf ImageMagick ImageMagick-devel php-devel php-pear && \
    dnf clean all
...
RUN dnf -y remove gcc make autoconf php-devel php-pear ImageMagick-devel
